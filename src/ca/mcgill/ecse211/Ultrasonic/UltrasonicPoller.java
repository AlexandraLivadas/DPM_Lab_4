...
public class UltrasonicPoller extends Thread {
	...
	public static UltrasonicPoller getInstance(SampleProvider us, float[] usData, USLocalizer cont,
	...
	private UltrasonicPoller(SampleProvider us, float[] usData, USLocalizer cont,
			final double MIN_DISTANCE) {
		this.us = us;
		this.cont = cont;
		this.usData = usData;
...
//	}
	...
	public USLocalizer getLocalizer() {
		return this.cont;
	}
